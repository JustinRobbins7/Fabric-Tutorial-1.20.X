...
public class CornCropBlock extends CropBlock {
    ...
    public void applyGrowth(World world, BlockPos pos, BlockState state) {
        ...
        // If crop's first stage is complete, create another corn block
        // Check if crop is at first stage max and block above is air.
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        // Also placement at either default crop placement or on the corn crop itself
