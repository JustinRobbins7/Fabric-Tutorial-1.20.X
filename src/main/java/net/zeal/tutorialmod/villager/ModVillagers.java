package net.zeal.tutorialmod.villager;
...
public class ModVillagers {
    ...
    private static PointOfInterestType registerPoi(String name, Block block) {
        // Point of interest type handles how villagers detect what block changes their profession
        // Ticket count makes each block unique per villager
