package net.zeal.tutorialmod.recipe;
...
public class GemPolishingRecipe implements Recipe<SimpleInventory> {
    ...
    public boolean matches(SimpleInventory inventory, World world) {
        ...
        // Checks first slot of inventory and compares to first item in recipe's json file
        // Will not always match indices
    ...
    // Define Serializer Class for getSerializer
