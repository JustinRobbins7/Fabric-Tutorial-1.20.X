package net.zeal.tutorialmod.screen;
...
public class GemPolishingScreenHandler extends ScreenHandler{
    ...
    public GemPolishingScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        // Puts items in inventory at the specified slots
        this.addSlot(new Slot(inventory, 0, 80, 11));
        this.addSlot(new Slot(inventory, 1, 80, 59));

        // Add player inventories to GUI
        // Might have to override if your GUI is particularly crazy
    ...
    public boolean isCrafting() {
        // Gets progress from passed into property delegate
    ...
    // This is the method for shift-clicking items into the block inventory
    @Override
